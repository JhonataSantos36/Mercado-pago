...
public interface PaymentService {
    ...
    @GET("/v1/checkout/payment_methods/search/options")
    ...
    MPCall<List<Instruction>> getInstructions(@Path(value = "payment_id", encoded = true) Long paymentId, @Query("public_key") String mKey);
